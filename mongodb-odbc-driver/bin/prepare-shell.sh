...
IODBCTEST_PATH="$BUILD_DIR"/iodbctest/
...
echo "MYSQL_PROJECT_DIR = $MYSQL_PROJECT_DIR"
echo "MONGOSQL_AUTH_PROJECT_DIR = $MONGOSQL_AUTH_PROJECT_DIR"

PATH="$PATH:$DEVENV_PATH:$CMAKE_PATH:$WIX_PATH:$IODBCTEST_PATH"
