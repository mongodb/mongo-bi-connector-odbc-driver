...
get_mongodb_download_url_for ()
{
   ...
   case "$_DISTRO" in
      ...
      ;;
     linux-rhel-9.3*)
          MONGODB_LATEST="http://downloads.10gen.com/linux/mongodb-linux-x86_64-enterprise-rhel93-latest.tgz"
          ;;
      linux-rhel-8.0*)
      ...
      ;;
      linux-ubuntu-22.04-aarch64)
          MONGODB_LATEST="https://downloads.mongodb.com/linux/mongodb-linux-x86_64-enterprise-ubuntu2204-latest.tgz"
      ;;
      windows32*)
